...
public class MainController {
	...
	public void genererTweets(ActionEvent event) {
		...
		String nb_tweets = "Nombre de tweets chargés : " + Integer.toString(t.nb_tweets());
	...
	public void bPopulaires(ActionEvent event) {
		...
		window = new Stage();
		window.setTitle("Popularité des utilisateurs");
		
		try {
			Parent root = FXMLLoader.load(getClass().getResource("populaires.fxml"));
